...
if st.button("Show Predictions 🚀"):
    ...
    if len(idx) == 0:
        ...
        payload = fe_df.loc[idx].fillna(0).replace([float("inf"), float("-inf")], 0).to_dict(orient="records")
        ...
        try:
            ...
            if region == "All":
                ...
                payload_all = fe_df.loc[idx_all].fillna(0).replace([float("inf"), float("-inf")], 0).to_dict(orient="records")
                ...
                payload_region = fe_df.loc[idx_region].fillna(0).replace([float("inf"), float("-inf")], 0).to_dict(orient="records")
